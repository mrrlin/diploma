 ...
 */
class LangController extends DefaultController
{
    /**
     * {@inheritdoc}
     */
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDesc($name)
    {
		if (($model = Lang::find()->where(['name' => $name])->one()) !== null) {
